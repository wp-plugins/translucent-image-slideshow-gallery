...
function TISG_slideshow() 
{
	...
	if(is_dir($TISG_dir))
	{
		...
		?>
		<script type="text/javascript" src="<?php echo $siteurl_link ?>wp-content/plugins/translucent-image-slideshow-gallery/jquery.min.js"></script>
		<script type="text/javascript" src="<?php echo $siteurl_link ?>wp-content/plugins/translucent-image-slideshow-gallery/translucent-image-slideshow-gallery.js"></script>
...
function TISG_widget_init() 
{
	...
	{
		register_widget_control(array('Translucent slideshow', 'widgets'), 'TISG_control');
	} 
}
...
function ISG_admin_option()
{
	...
	echo $TISG_dir . '" name="TISG_dir" id="TISG_dir" /> [TISG:CODE=SD1:W=200:H=150]</p>';
	echo '<p>All image link:<br><input  style="width: 650px;" type="text" value="';
	...
	?>
	<h2><?php echo wp_specialchars( 'Plugin configuration' ); ?></h2>
	Plug-in created by <a target="_blank" href='http://www.gopiplus.com/work/'>www.gopiplus.com</a>.<br>
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/translucent-image-slideshow-gallery/'>Click here</a> to find the short code for posts/pages.<br>
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/translucent-image-slideshow-gallery/'>Click here</a> to see live demo and video tutorial.<br><br>
...
function TISG_show_filter_callback($matches) 
{
	...
	if(is_dir($TISG_dir))
	{
		...
		$tiag = $tiag . '<script type="text/javascript"> ';
